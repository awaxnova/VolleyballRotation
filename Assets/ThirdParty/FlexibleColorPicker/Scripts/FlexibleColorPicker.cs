...
public class FlexibleColorPicker : MonoBehaviour {
    ...
    */
    ...
    private ColorUpdateEvent onColorChange;
    public ColorUpdateEvent onColorChanged;
    ...
    */
    ...
    private void OnEnable() {
        ...
        // onColorChanged.Invoke(startingColor); // We don't want the starting color to be considered a change that invokes the external listeners.
    }
