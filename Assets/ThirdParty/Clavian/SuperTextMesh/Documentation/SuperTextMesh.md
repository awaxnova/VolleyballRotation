...
* Certain versions or configurations of Unity seem to be unable to render dropshadows or outlines in Unity UI with the Ultra shader, while disabling those effects works fine. Currently looking into the cause.
