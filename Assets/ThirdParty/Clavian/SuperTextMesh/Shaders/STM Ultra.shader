Shader "Super Text Mesh/Ultra" {
	Properties 
	{
		...
		*/
		...
		[ShowIf(EFFECT_DROPSHADOW)][Enum(Angle, 0, Position, 1)] _DropshadowType ("Dropshadow Type", int) = 0
		...
		[ShowIf(EFFECT_DROPSHADOW)] _DropshadowAngle3 ("Dropshadow Angle3", Vector) = (1,-1,0)
		/*
